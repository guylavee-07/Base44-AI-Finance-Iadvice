    ...
    return (
        <div className="text-center space-y-8 py-8 animate-in fade-in duration-500">
            <div className="space-y-4">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-blue-500 shadow-xl shadow-blue-400/30 mb-4">
                    <TrendingUp className="h-10 w-10 text-white" />
                </div>
                <h2 className="text-3xl font-bold text-slate-800">
                    ברוכים הבאים למערכת הייעוץ העסקי המתקדמת
                </h2>
                <a 
                    href="https://iadvice.co.il/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-lg text-blue-600 font-medium hover:text-blue-700 hover:underline transition-colors"
                >
                    יפתח ונגר יעוץ עסקי
                </a>
                
                {/* Professional Introduction */}
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 max-w-2xl mx-auto text-right">
                    <h3 className="font-bold text-blue-900 text-lg mb-3">אודות המערכת</h3>
                    <div className="space-y-3 text-slate-700 text-sm leading-relaxed">
                        <p>
                            <strong>מערכת זו מספקת ייעוץ עסקי והשקעות מבוסס בינה מלאכותית</strong> תחת פיקוח של יועץ השקעות מוסמך.
                            המערכת מאפשרת לקבל מידע כללי, המלצות והדרכה בנושאי השקעות, חסכונות, ניהול פיננסי ותכנון כלכלי.
                        </p>
                        <p>
                            <strong>חשוב לדעת:</strong> המידע והמלצות הניתנים במערכת הם למטרות אינפורמטיביות בלבד ואינם מהווים 
                            ייעוץ השקעות מחייב או המלצה לביצוע עסקה ספציפית. לפני כל החלטה השקעתית, מומלץ להיוועץ עם יועץ מוסמך.
                        </p>
                        <p>
                            <strong>רגולציה ופיקוח:</strong> שירותי הייעוץ ניתנים על ידי יועץ השקעות בעל רישיון תקף מרשות ניירות ערך,
                            בהתאם לחוק הסדרת העיסוק בייעוץ השקעות, תשנ"ה-1995. כל הפעילות כפופה לדיני רשות ניירות ערך והוראות הפיקוח.
                        </p>
                        <p className="font-medium text-blue-800">
                            ⚠️ השקעות בשוק ההון כרוכות בסיכונים, לרבות אובדן קרן או חלקה. אין בהמלצות כדי להבטיח רווח או למנוע הפסד.
                        </p>
                    </div>
                </div>

                <p className="text-slate-600 text-lg max-w-md mx-auto leading-relaxed pt-4">
